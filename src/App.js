...
const App = () => (
  <div className="tech-container">
    <div className="tech-card-list">
      <h1 className="main-card-head">Learn 4.0 Technologies</h1>
      <p className="main-card-description">
        Get trained by alumni of IITs and top companies like Amazon, Microsoft,
        Intel, Nvida, Qualcomm, etc. Learn directly from Professionals involed
        in Product Development.
      </p>
      <ul className="tech-card">
        {cardsList.map(eachItem => (
          <TechnologyCard techDetails={eachItem} key={eachItem.id} />
        ))}
      </ul>
    </div>
  </div>
